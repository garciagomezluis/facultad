...
void check_estado_a(){
    ...
    carrera.nuevoCorredor(4,3);
    ASSERT_EQ(to_s(carrera), "[1, 2, 4, 3]");
...
void check_estado_b(){
    ...
    carrera.nuevoCorredor(1);
    carrera.nuevoCorredor(2);
    carrera.nuevoCorredor(3,2);
    ASSERT_EQ(to_s(carrera), "[1, 3, 2]");
    carrera.sobrepasar(2);
    ASSERT_EQ(to_s(carrera), "[1, 2, 3]");
    carrera.seCansa(2);
    ASSERT_EQ(to_s(carrera), "[1, 3]");
...
void check_posicion() {
    ...
    ASSERT_EQ(carrera.damePosicion(1),0);
    ASSERT_EQ(carrera.damePosicion(3),2);
    ASSERT_EQ(carrera.damePosicion(8),4);

    ASSERT_EQ(carrera.dameCorredorEnPos(0),1);
    ASSERT_EQ(carrera.dameCorredorEnPos(2),3);
    ASSERT_EQ(carrera.dameCorredorEnPos(4),8);

    carrera.seCansa(5);

    ASSERT_EQ(carrera.damePosicion(8),3);
    ASSERT_EQ(carrera.dameCorredorEnPos(3),8);
}

int main() {
    RUN_TEST(check_estado_a);
    RUN_TEST(check_estado_b);
